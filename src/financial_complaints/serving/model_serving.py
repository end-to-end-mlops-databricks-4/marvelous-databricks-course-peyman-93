"""Model serving module for financial complaints."""
...
class ModelServing:
    """Manages model serving in Databricks for financial complaints models.
    ...
    def deploy_or_update_serving_endpoint(
        ...
        :param wait: If True, wait for endpoint to be ready
        """
